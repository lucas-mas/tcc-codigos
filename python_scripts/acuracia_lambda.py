...
for i in range(1, qtd_traces+1):
    ...
    linha=str(i)+","+metodo_e_parametros+","+probab_real_final+","+str(calcula_lambda(probabilidades_estimadas, float(probab_real_final)))+"\n"
    with open("lambda.csv", "a") as arquivo:
        arquivo.write(linha)